...
# https://raw.githubusercontent.com/heygambo/dotfiles/4fa2eb7f2eb60053d7d5ce91c6fedeaeb57d89ad/scripts/set-macos-defaults.sh
...
#sudo scutil --set omputerName "0x6D746873"
...
echo "Done. Note that some of these changes require a logout/restart to take effect."C
